...
#define UART1_CONFIG \
    { .name = "uart1", .uart_type = 0, .Instance = USART1, .irq_type = USART1_IRQn, \
      .tx_dma_instance = DMA1_Channel1, .tx_dma_channel = 1, .tx_dma_irq = DMA1_CH1_IRQn, \
      .rx_dma_instance = DMA1_Channel2, .rx_dma_channel = 2, .rx_dma_irq = DMA1_CH2_IRQn }
#else
#define UART1_CONFIG \
    { .name = "uart1", .uart_type = 0, .Instance = USART1, .irq_type = USART1_IRQn, \
      .tx_dma_instance = UART_DMA_NONE, .tx_dma_channel = UART_DMA_CH_NONE, .tx_dma_irq = (IRQn_Type)0, \
      .rx_dma_instance = UART_DMA_NONE, .rx_dma_channel = UART_DMA_CH_NONE, .rx_dma_irq = (IRQn_Type)0 }
#endif
#endif
...
#define UART2_CONFIG \
    { .name = "uart2", .uart_type = 0, .Instance = USART2, .irq_type = USART2_IRQn, \
      ...
      .rx_dma_instance = UART_DMA_NONE, .rx_dma_channel = UART_DMA_CH_NONE, .rx_dma_irq = (IRQn_Type)0 }
#else
#define UART2_CONFIG_DMA \
    { .name = "uart2", .uart_type = 0, .Instance = USART2, .irq_type = USART2_IRQn, \
      .tx_dma_instance = DMA1_Channel3, .tx_dma_channel = 3, .tx_dma_irq = DMA1_CH3_IRQn, \
      .rx_dma_instance = DMA1_Channel4, .rx_dma_channel = 4, .rx_dma_irq = DMA1_CH4_IRQn }
#endif
#endif
...
#define UART3_CONFIG \
    { .name = "uart3", .uart_type = 0, .Instance = USART3, .irq_type = USART3_IRQn, \
      ...
      .rx_dma_instance = UART_DMA_NONE, .rx_dma_channel = UART_DMA_CH_NONE, .rx_dma_irq = (IRQn_Type)0 }
#else
#define UART3_CONFIG_DMA \
    { .name = "uart3", .uart_type = 0, .Instance = USART3, .irq_type = USART3_IRQn, \
      .tx_dma_instance = DMA1_Channel5, .tx_dma_channel = 5, .tx_dma_irq = DMA1_CH5_IRQn, \
      .rx_dma_instance = DMA1_Channel6, .rx_dma_channel = 6, .rx_dma_irq = DMA1_CH6_IRQn }
#endif
#endif
...
#define UART4_CONFIG \
    { .name = "uart4", .uart_type = 0, .Instance = USART4, .irq_type = USART4_IRQn, \
      ...
      .rx_dma_instance = UART_DMA_NONE, .rx_dma_channel = UART_DMA_CH_NONE, .rx_dma_irq = (IRQn_Type)0 }
#else
#define UART4_CONFIG_DMA \
    { .name = "uart4", .uart_type = 0, .Instance = USART4, .irq_type = USART4_IRQn, \
      .tx_dma_instance = DMA1_Channel7, .tx_dma_channel = 7, .tx_dma_irq = DMA1_CH7_IRQn, \
      .rx_dma_instance = DMA2_Channel1, .rx_dma_channel = 1, .rx_dma_irq = DMA2_CH1_IRQn }
#endif
#endif
