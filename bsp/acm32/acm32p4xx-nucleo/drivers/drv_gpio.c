...
static const struct pin_index pins[] =
{
    ...
    __ACM32_PIN(78,  E, 14),
    __ACM32_PIN(79,  E, 15),
    /* Port F (80-95) / G (96-111) — needed for SPI2_CS_PF6, SPI3_CS_PG4, etc. */
    __ACM32_PIN(80,  F, 0),
    __ACM32_PIN(81,  F, 1),
    __ACM32_PIN(82,  F, 2),
    __ACM32_PIN(83,  F, 3),
    ...
    __ACM32_PIN(104, G, 8),
    __ACM32_PIN(105, G, 9),
    __ACM32_PIN(106, G, 10),
    __ACM32_PIN(107, G, 11),
    __ACM32_PIN(108, G, 12),
    __ACM32_PIN(109, G, 13),
    __ACM32_PIN(110, G, 14),
    __ACM32_PIN(111, G, 15),
