...
/* ETH MMC Configuration Structure definition================================= */
typedef struct
{
    FunctionalState CntStopRollover;      /*<! Enables or disables the counter to roll over to zero after reaching the maximum value. */

    FunctionalState ResetOnRead;          /*<! Enables or disables the MMC counters to reset to zero after Read. 
                                               The counters are cleared when the least significant byte lane (Bits[7:0]) is read.*/
    
    FunctionalState UpdateCntforDBF;      /*<! Enables or disables the MMC counters to update for broadcast framesthat 
                                               are dropped because of the setting of Bit5(DBF)@ETH_MACFFR.*/

} ETH_MMCConfigTypeDef;
...
typedef struct
{
    ...
    FunctionalState      RebuildINCRxBurst;           /*!< Enables or disables Rebuild the pending beats with a combination 
                                                           of specified bursts with INCRx and SINGLE. 
                                                           An unspecified (INCR) burst, by default. */
    ...
    FunctionalState      DropGiantFrames;             /*!< Enables or disables the Dropping of Giant Frames */
...
typedef enum
{
    ...
    HAL_ETH_RMII_MODE            = SYSCFG_SYSCR_EPIS_RMII    /*!< Reduced Media Independent Interface     */
...
typedef struct
{
    ...
    FunctionalState DropNonTCPUDPPPackets;    /*!< Enable or Disable Drop Non-TCP/UDP over IP Packets */
...
/* ETH VLAN tag filter structure definition=================================== */
typedef struct
{
    FunctionalState VLANTagHashTableMatch;    /*!< Enable or Disable VLAN Tag Hash Table Match */

    FunctionalState SVLANType;                /*!< Enable or Disable S-VLAN (Type = 0x88A8) frames as valid VLAN tagged frames */

    FunctionalState VLANTagInverseMatch;      /*!< Enable or Disable VLAN Tag inverse match */

    FunctionalState VLANTagComparison12Bit;   /*!< Enable or Disable 12-Bit VLAN Tag Comparison */

//    uint32_t        VLANTag;                  /*!< The VLAN Tag for Receive Frames */
...
#define ETH_DMATXDESC_CRCR                    0x09000000U  /*!< CRC Replacement Enable, CRC replacement is done only when Bit 27 (DC) is set to 1 */
#define ETH_DMATXDESC_CIC                                   0x00C00000U  /*!< Checksum Insertion Control: 4 cases */
#define ETH_DMATXDESC_CIC_DISABLE                           0x00000000U  /*!< Checksum Insertion Disabled */
#define ETH_DMATXDESC_CIC_IPHDR_INSERT                      0x00400000U  /*!< Only IP header checksum calculation and insertion are enabled */
#define ETH_DMATXDESC_CIC_IPHDR_PALOAD_INSERT               0x00800000U  /*!< IP header checksum and payload checksum calculation and insertion are enabled, but pseudo-header checksum is not calculated in hardware */
#define ETH_DMATXDESC_CIC_IPHDR_PAYLOAD_INSERT_PHDR_CALC    0x00C00000U  /*!< IP Header checksum and payload checksum calculation and insertion are enabled, and pseudo-header checksum is calculated in hardware */
#define ETH_DMATXDESC_TER                     0x00200000U  /*!< Transmit End of Ring */
#define ETH_DMATXDESC_TCH                     0x00100000U  /*!< Second Address Chained */
#define ETH_DMATXDESC_VIC                     0x000C0000U  /*!< VLAN Tag Insertion or Replacement mask */
#define ETH_DMATXDESC_VIC_DISABLE             0x00000000U  /*!< Do not add a VLAN tag. */
#define ETH_DMATXDESC_VIC_REMOVE              0x00040000U  /*!< Remove the VLAN tag from the packets before transmission. */
#define ETH_DMATXDESC_VIC_INSERT              0x00080000U  /*!< Insert a VLAN tag. */
#define ETH_DMATXDESC_VIC_REPLACE             0x000C0000U  /*!< Replace the VLAN tag. */
...
#define ETH_DMATXDESC_MAR                     0x800000000  /*!< MAC Address Register mask */
#define ETH_DMATXDESC_MAR_0                   0x000000000  /*!< MAC Address Register 0 */
#define ETH_DMATXDESC_MAR_1                   0x800000000  /*!< MAC Address Register 1 */
#define ETH_DMATXDESC_SAIC                    0x60000000U  /*!< SA Insertion Control mask */
#define ETH_DMATXDESC_SAIC_DISABLE            0x00000000U  /*!< SA Insertion Control: Do not include the source address */
#define ETH_DMATXDESC_SAIC_INSERT             0x20000000U  /*!< SA Insertion Control: Include or insert the source address */
#define ETH_DMATXDESC_SAIC_REPLACE            0x40000000U  /*!< SA Insertion Control: Replace the source address */
...
#define ETH_DMARXDESC_IPHCETSV    0x00000080U  /*!< IPC Checksum Error/Timestamp Available   */
...
#define ETH_DMARXDESC_PCEESA      0x00000001U  /*!< Payload checksum error / extended status available */
...
#define ETH_DMARXDESC_L3L4FM                             0x0C000000U  /*!< L3 and L4 Filter Number Matched       */
#define ETH_DMARXDESC_L4FM                               0x02000000U  /*!< Layer 4 Filter Match                  */
#define ETH_DMARXDESC_L3FM                               0x01000000U  /*!< Layer 3 Filter Match                  */                                                                                     
#define ETH_DMARXDESC_TD                                 0x00004000U  /*!< Timestamp Dropped  */
#define ETH_DMARXDESC_PV                                 0x00002000U  /*!< PTP Version  */
#define ETH_DMARXDESC_PFT                                0x00001000U  /*!< PTP Packet Type  */
#define ETH_DMARXDESC_PMT                                0x00000F00U  /*!< PTP Message Type mask  */
#define ETH_DMARXDESC_PMT_NO                             0x00000000U  /*!< PTP Message Type: No PTP message received  */
#define ETH_DMARXDESC_PMT_SYNC                           0x00000100U  /*!< PTP Message Type: SYNC (all clock types)  */
#define ETH_DMARXDESC_PMT_FUP                            0x00000200U  /*!< PTP Message Type: Follow_Up (all clock types)  */
#define ETH_DMARXDESC_PMT_DREQ                           0x00000300U  /*!< PTP Message Type: Delay_Req (all clock types)  */
#define ETH_DMARXDESC_PMT_DRESP                          0x00000400U  /*!< PTP Message Type: Delay_Resp (all clock types)  */
#define ETH_DMARXDESC_PMT_PDREQ                          0x00000500U  /*!< PTP Message Type: Pdelay_Req (in peer-to-peer transparent clock)  */
#define ETH_DMARXDESC_PMT_PDRESP                         0x00000600U  /*!< PTP Message Type: Pdelay_Resp (in peer-to-peer transparent clock)  */
#define ETH_DMARXDESC_PMT_PDRESPFUP                      0x00000700U  /*!< PTP Message Type: Pdelay_Resp_Follow_Up (in peer-to-peer transparent clock)  */
#define ETH_DMARXDESC_PMT_RESERVED                       0x00000F00U  /*!< PTP Message Type: PTP packet with Reserved message type  */
#define ETH_DMARXDESC_IPV6PR                             0x00000080U  /*!< IPv6 Packet Received */
#define ETH_DMARXDESC_IPV4PR                             0x00000040U  /*!< IPv4 Packet Received */
#define ETH_DMARXDESC_IPCB                               0x00000020U  /*!< IP Checksum Bypassed */
#define ETH_DMARXDESC_IPPE                               0x00000010U  /*!< IP Payload Error */
#define ETH_DMARXDESC_IPHE                               0x00000008U  /*!< IP Header Error */
#define ETH_DMARXDESC_IPPT                               0x00000007U  /*!< IP Payload Type */
#define ETH_DMARXDESC_IPPT_UNKNOWN                       0x00000000U  /*!< Payload Type: Unknown type */
#define ETH_DMARXDESC_IPPT_UDP                           0x00000001U  /*!< UDP payload encapsulated in the IP datagram */
#define ETH_DMARXDESC_IPPT_TCP                           0x00000002U  /*!< TCP payload encapsulated in the IP datagram */
#define ETH_DMARXDESC_IPPT_ICMP                          0x00000003U  /*!< ICMP payload encapsulated in the IP datagram */
...
/* ETH_Frame_settings ETH frame settings====================================== */
...
/* ETH_Tx_Packet_CRC_Pad_Control ETH Tx Packet CRC Pad Control================ */
#define ETH_CRC_PAD_CTRL         0x0D000000U
...
#define ETH_CRC_DISABLE          ETH_DMATXDESC_DC
#define ETH_CRC_REPLACE          ETH_DMATXDESC_CRCR

/* ETH_Tx_Packet_Checksum_Control ETH Tx Packet Checksum Control============== */
#define ETH_CHECKSUM_DISABLE                         ETH_DMATXDESC_CIC_DISABLE
#define ETH_CHECKSUM_IPHDR_INSERT                    ETH_DMATXDESC_CIC_IPHDR_INSERT
#define ETH_CHECKSUM_IPHDR_PAYLOAD_INSERT            ETH_DMATXDESC_CIC_IPHDR_PALOAD_INSERT
#define ETH_CHECKSUM_IPHDR_PAYLOAD_INSERT_PHDR_CALC  ETH_DMATXDESC_CIC_IPHDR_PAYLOAD_INSERT_PHDR_CALC

/* ETH_Rx_MAC_Filter_Status ETH Rx MAC Filter Status========================== */
...
/* ETH_Rx_Error_Code ETH Rx Error Code======================================== */
...
/* ETH_DMA_Arbitration ETH DMA Arbitration==================================== */
...
/* ETH_Tx_DMA_Burst_Length ETH Tx DMA Burst Length============================ */
...
#define ETH_TXDMABURSTLENGTH_8XPBL_8BEAT    0x01000100U  /*!< maximum number of beats to be transferred in one TxDMA (or both) transaction is 8   */
#define ETH_TXDMABURSTLENGTH_8XPBL_16BEAT   0x01000200U  /*!< maximum number of beats to be transferred in one TxDMA (or both) transaction is 16  */
#define ETH_TXDMABURSTLENGTH_8XPBL_32BEAT   0x01000400U  /*!< maximum number of beats to be transferred in one TxDMA (or both) transaction is 32  */
#define ETH_TXDMABURSTLENGTH_8XPBL_64BEAT   0x01000800U  /*!< maximum number of beats to be transferred in one TxDMA (or both) transaction is 64  */
#define ETH_TXDMABURSTLENGTH_8XPBL_128BEAT  0x01001000U  /*!< maximum number of beats to be transferred in one TxDMA (or both) transaction is 128 */
#define ETH_TXDMABURSTLENGTH_8XPBL_256BEAT  0x01002000U  /*!< maximum number of beats to be transferred in one TxDMA (or both) transaction is 256 */

/* ETH_Rx_DMA_Burst_Length ETH Rx DMA Burst Length============================ */
...
#define ETH_RXDMABURSTLENGTH_32BEAT         0x00C00000U  /*!< maximum number of beats to be transferred in one RxDMA transaction is 32  */
#define ETH_RXDMABURSTLENGTH_8XPBL_8BEAT    0x01020000U  /*!< maximum number of beats to be transferred in one RxDMA transaction is 8   */
#define ETH_RXDMABURSTLENGTH_8XPBL_16BEAT   0x01040000U  /*!< maximum number of beats to be transferred in one RxDMA transaction is 16  */
#define ETH_RXDMABURSTLENGTH_8XPBL_32BEAT   0x01080000U  /*!< maximum number of beats to be transferred in one RxDMA transaction is 32  */
#define ETH_RXDMABURSTLENGTH_8XPBL_64BEAT   0x01100000U  /*!< maximum number of beats to be transferred in one RxDMA transaction is 64  */
#define ETH_RXDMABURSTLENGTH_8XPBL_128BEAT  0x01200000U  /*!< maximum number of beats to be transferred in one RxDMA transaction is 128 */
#define ETH_RXDMABURSTLENGTH_8XPBL_256BEAT  0x01400000U  /*!< maximum number of beats to be transferred in one RxDMA transaction is 256 */
...
/* ETH_DMA_Status_Flags ETH DMA Status Flags================================== */
...
/* ETH_Transmit_Mode ETH Transmit Mode======================================== */
...
/* ETH_Receive_Mode ETH Receive Mode========================================== */
...
///* ETH_Pause_Low_Threshold  ETH Pause Low Threshold========================= */
...
/* ETH_Source_Addr_Control ETH Source Addr Control============================ */
...
/* ETH_MAC_Interrupts ETH MAC Interrupts====================================== */
#define ETH_MAC_PMT_IT           ETH_MACISR_PMTS

/* ETH_MAC_Wake_Up_Event ETH MAC Wake Up Event================================ */
#define ETH_WAKEUP_FRAME_RECIEVED     ETH_MACPMTCSR_WFR
#define ETH_MAGIC_PACKET_RECIEVED     ETH_MACPMTCSR_MPR

/* ETH_State_Codes ETH States================================================= */
...
/* ETH_Pass_Control_Frames ETH Pass Control Frames============================ */
...
/* ETH_Unicast_Frames_Filter ETH Unicast Frames Filter======================== */
...
/* ETH_Zero_Quanta_Pause ETH Zero Quanta Pause================================ */
...
/* ETH_Transmit_Threshold_Control ETH Transmit Threshold Control============== */
...
/* ETH_Receive_Threshold_Control ETH Receive Threshold Control================ */
...
/* ETH_VLAN_Tag_Control ETH VLAN Tag Control================================== */
#define ETH_VLANTAGCONTROL_NONE       (ETH_MACVTIRR_VLP | ETH_MACVTIRR_VLC_NOVLANTAG)
#define ETH_VLANTAGCONTROL_DELETE     (ETH_MACVTIRR_VLP | ETH_MACVTIRR_VLC_VLANTAGDELETE)
#define ETH_VLANTAGCONTROL_INSERT     (ETH_MACVTIRR_VLP | ETH_MACVTIRR_VLC_VLANTAGINSERT)
#define ETH_VLANTAGCONTROL_REPLACE    (ETH_MACVTIRR_VLP | ETH_MACVTIRR_VLC_VLANTAGREPLACE)

/* ETH_L3_Filter ETH L3 Filter================================================ */
#define ETH_L3_FILTER_0                 0x00000000U
#define ETH_L3_FILTER_1                 0x0000000CU

/* ETH_L4_Filter ETH L4 Filter================================================ */
#define ETH_L4_FILTER_0                 0x00000000U
#define ETH_L4_FILTER_1                 0x0000000CU

/* ETH_L3_Protocol ETH L3 Protocol============================================ */
#define ETH_L3_IPV6_MATCH                       ETH_MACL3L4CR_L3PEN
#define ETH_L3_IPV4_MATCH                       0x00000000U

/* ETH_L3_Source_Match ETH L3 Source Match==================================== */
...
/* ETH_L3_Destination_Match ETH L3 Destination Match========================== */
...
/* ETH_L4_Destination_Match ETH L4 Destination Match========================== */
...
/* ETH_DMA_Tx_descriptor_segment ETH DMA Tx descriptor segment================ */
#define ETH_DMATXDESC_LASTSEGMENTS      0x40000000U  /*!< Last Segment */
#define ETH_DMATXDESC_FIRSTSEGMENT      0x20000000U  /*!< First Segment */

/* ETH_DMA_Tx_descriptor_Checksum_Insertion_Control ETH DMA Tx descriptor Checksum Insertion Control== */
...
/* ETH_MMC_Tx_Interrupts ETH MMC Tx Interrupts================================ */
...
/* ETH_MMC_Rx_Interrupts ETH MMC Rx Interrupts================================ */
...
/* ETH_DMA_transmit_process_state ETH DMA transmit process state============== */
...
/* ETH_DMA_receive_process_state ETH DMA receive process state================ */
...
/* ETH_DMA_overflow ETH DMA overflow========================================== */
...
/* ETH_PTP_Config_Status ETH PTP Config Status================================ */
...
/*!< External interrupt line 33 Connected to the ETH wakeup EXTI Line */
#define ETH_WAKEUP_EXTI_LINE  0x00000002U /* !<  33 - 32 = 1 */
...
/**
  ...
  * @retval None.
  */
#define __HAL_ETH_WAKEUP_EXTI_ENABLE_IT(__EXTI_LINE__)  (EXTI->IENR2 |= (__EXTI_LINE__))
...
/**
  ...
  */
#define __HAL_ETH_WAKEUP_EXTI_GET_FLAG(__EXTI_LINE__)  (EXTI->PDR2 & (__EXTI_LINE__))
...
/**
  ...
  * @retval None.
  */
#define __HAL_ETH_WAKEUP_EXTI_CLEAR_FLAG(__EXTI_LINE__)  (EXTI->PDR2 = (__EXTI_LINE__))
...
/**
  ...
  * @retval None
  */
#define __HAL_ETH_WAKEUP_EXTI_ENABLE_RISING_EDGE(__EXTI_LINE__)  (EXTI->FTENR2 = ~(__EXTI_LINE__)); \
                                                                    (EXTI->RTENR2 |= (__EXTI_LINE__))
/**
  ...
  * @retval None
  */
#define __HAL_ETH_WAKEUP_EXTI_ENABLE_FALLING_EDGE(__EXTI_LINE__)  (EXTI->RTENR2 &= ~(__EXTI_LINE__)); \
                                                                     (EXTI->FTENR2 |= (__EXTI_LINE__))
/**
  * @brief  enable rising and falling edge interrupt on selected EXTI line.
  * @param  __EXTI_LINE__: specifies the ETH WAKEUP EXTI sources to be disabled.
  * @arg ETH_WAKEUP_EXTI_LINE
  * @retval None
  */
#define __HAL_ETH_WAKEUP_EXTI_ENABLE_RISING_FALLING_EDGE(__EXTI_LINE__)  (EXTI->RTENR2 |= (__EXTI_LINE__)); \
                                                                           (EXTI->FTENR2 |= (__EXTI_LINE__))
/**
...
void              HAL_ETH_EnterLPIMode(ETH_HandleTypeDef *heth, FunctionalState TxAutomate,
